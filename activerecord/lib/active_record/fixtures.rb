  ...
  class FixtureSet
    ...
    def self.create_fixtures(fixtures_directory, fixture_set_names, class_names = {}, config = ActiveRecord::Base)
      ...
      unless files_to_read.empty?
        ...
        fixture_sets_by_connection = fixture_sets.group_by { |fs| (fs.model_class ? fs.model_class.connection : connection).object_id }

        deleted_tables = Hash.new { |h, k| h[k] = Set.new }

        fixture_sets_by_connection.each_value do |set|
          conn = set.first.model_class ? set.first.model_class.connection : connection
          ...
          conn.insert_fixtures(table_rows_for_connection, deleted_tables[conn])
